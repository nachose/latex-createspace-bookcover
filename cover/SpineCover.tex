...
\geometry{
  ...
  left=\dimexpr\VerBleed in + 0.125in\relax,%
  right=\dimexpr\VerBleed in + 0.125in\relax,%
  top=\dimexpr\FoldVariance in + 0.125in\relax,%
  bottom=\dimexpr\FoldVariance in + 0.125in\relax,%
  footskip=0.0 in%
}
...
\ifthenelse{\TotalPageCount < 215}{%
 ...
 %  \end{minipage}
   \begin{minipage}[c][\textheight]{0.1\linewidth}
     \includegraphics[width=15mm,angle=90,origin=c]{../images/PressLogo.png}%
  \end{minipage}
}%  
\end{document}
