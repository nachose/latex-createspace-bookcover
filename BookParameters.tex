...
\pgfmathsetmacro\TotalPageCount{286}% Must be manually entered
\pgfmathsetmacro\PaperWidthPt{5.00in}%
\pgfmathsetmacro\PaperHeightPt{8.00in}%

\newlength{\PaperW}\setlength{\PaperW}{5.00in}
\newlength{\PaperH}\setlength{\PaperH}{8.00in}
...
\def\TheMainTitle{Great Sagas of Science Fiction}
\def\TheSubTitle{}
\def\TheSubTitleA{}
\def\TheSubTitleB{}
\def\TheBookSeries{}
...
\textsf{\textbf{Great Sagas of Science Fiction} -- From the groundbreaking visions of Isaac Asimov’s Foundation to the modern masterpieces of N.K. Jemisin’s Broken Earth, this book delves into the worlds of New Wave, space opera, cyberpunk, and beyond. Discover how these multi-book sagas tackle humanity’s greatest questions—identity, power, survival, and exploration—offering both timeless classics and contemporary gems for every sci-fi enthusiast. Perfect for fans seeking the genre’s most unforgettable stories and profound ideas.}}
