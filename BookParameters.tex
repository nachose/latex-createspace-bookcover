...
\pgfmathsetmacro\TotalPageCount{524}% Must be manually entered
...
\def\TheMainTitle{Gradle Build Tool}
\def\TheSubTitle{}
\def\TheSubTitleA{}
\def\TheSubTitleB{}
\def\TheBookSeries{}
...
\textsf{\textbf{{Gradle Build Tool} -- Gradle Build Tool is a practical guide to Gradle, the modern build automation system widely used for Java, Kotlin, Android, and many other software projects. It explains how to automate compiling, testing, packaging, dependency management, and deployment while taking advantage of Gradle's flexible, task-based architecture and powerful plugin ecosystem.}}

\textsf{\textbf{The book covers both the fundamentals and more advanced topics, including build scripts, multi-project builds, custom tasks, plugins, performance optimization, and integration with continuous integration pipelines. It is intended for software developers who want to create maintainable, efficient, and scalable build processes, whether they are new to Gradle or looking to deepen their expertise.}}
}
